          ...
          {projects.map(project => (
            <div key={project.id}>
              <div
                ...
                data-aos-offset='200'
                data-aos-once='true'>
                <div className='items-center justify-center h-auto w-full shadow-lg shadow-gray-400 dark:shadow-gray-100 rounded-xl p-4 group hover:shadow-[#1BA8F0] hover:scale-105 ease-in duration-100'>
                  <Image
                  ...
                  <div className='flex items-center justify-center'>
                    <div className='pr-2'>
                      <div className='px-2 sm:px-4 p-1.5 sm:p-2 rounded-full bg-white dark:bg-[#323232] cursor-pointer hover:bg-[#1BA8F0] ease-in duration-200'>
                        <Link
