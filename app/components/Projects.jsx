          ...
          {projects.map(project => (
            <div key={project.id}>
              <div
                ...
                data-aos-offset='200'
                data-aos-once='true'>
                <div className='items-center justify-center h-auto w-full shadow-lg shadow-gray-400 dark:shadow-gray-100 rounded-xl p-4 group hover:shadow-[#8c52ff] hover:scale-105 ease-in duration-100'>
                  <Image
